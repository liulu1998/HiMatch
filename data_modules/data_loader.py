...
def data_loaders(config, vocab, data={'train': None, 'val': None, 'test': None, 'desc': None}, bert_tokenizer=None,
                 only_train=False):
    """
    ...
    # new
    label_desc_dataset = ClassificationDataset(config, vocab, stage='DESC', on_memory=on_memory,
                                               corpus_lines=data['desc'], bert_tokenizer=bert_tokenizer)
